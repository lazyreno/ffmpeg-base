...
function(validate_video_to_mp3_output_capabilities tool_path)
    validate_runtime_muxer("${tool_path}" "aiff")
    validate_runtime_component("${tool_path}" "-encoders" "pcm_s16be" "encoder")
    validate_runtime_component("${tool_path}" "-encoders" "wmav2" "encoder")
endfunction()
...
if(SDK_PLATFORM STREQUAL "macos")
    ...
    validate_video_to_mp3_output_capabilities("${SDK_ROOT}/bin/ffmpeg")
...
elseif(SDK_PLATFORM STREQUAL "windows")
    ...
    if(NOT SDK_ARCH STREQUAL "arm64")
        ...
        validate_video_to_mp3_output_capabilities("${SDK_ROOT}/bin/ffmpeg.exe")
