...
require_contains("${windows_build_script_content}" "VCToolsInstallDir" "Windows build must require the MSVC toolchain library directory")
require_contains("${windows_build_script_content}" "libcmt\\.lib" "Windows build must verify that the MSVC CRT library is available")
require_contains("${windows_build_script_content}" "\\$MsvcLibraryFlag" "Windows build must pass the MSVC library directory to FFmpeg's linker")
foreach(codec_dependency IN ITEMS x264 x265)
